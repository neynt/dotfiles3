...
keys.globalkeys = gears.table.join(
  ...
  awful.key({ modkey, "Shift"   }, "b",              function () awful.spawn('brave')   end, { description = "open a browser" , group = "launcher" }),
...
keys.clientkeys = gears.table.join(
  ...
  awful.key({ modkey,           }, "y", function (c) awful.client.floating.toggle(c); c.ontop = c.floating end, { description = "toggle floating", group = "client" }),
